$(function(){
  ...
  //insta feed
  // $.ajax({
  //   url: 'https://www.instagram.com/graphql/query/?query_hash=472f257a40c653c64c666ce877d59d2b&variables={%22id%22:%227741927326%22,%22first%22:12,%22after%22:null}',
  //   type: 'GET',
  //   dataType: 'json',
  //   success: function(data) {
  ...
  $.instagramFeed({
    ...
    'callback': function(data) {
      var igFeed = data.edge_owner_to_timeline_media.edges;
      $(igFeed).each(function(i,obj) {
              var igPost = obj.node;
              var imgThumb = obj.node.thumbnail_src;
              var imgFull = obj.node.display_url;
